        ...
        <div>
          ...
          <div class="card-body align-content-center pt-3 mt-3 pt-md-5 mt-md-5">
            ...
            <form method="POST" action="PerfilServlet">
              <div class="row mb-3">
                <label for="email" class="col-md-4 col-form-label text-md-end" style="color: #ffff">Nome</label>
                <div class="col-md-8">
                  <input id="nome" type="text" class="form-control" name="nome" required autocomplete="" autofocus>
              ...
              <div class="row mb-3">
                <label for="email" class="col-md-4 col-form-label text-md-end" style="color: #ffff">Cidade</label>
                <div class="col-md-8">
                  <input id="cidade" type="text" class="form-control" name="cidade" required autocomplete="" autofocus>
              ...
              <div class="row mb-3">
                <label for="email" class="col-md-4 col-form-label text-md-end" style="color: #ffff">Bairro</label>
                <div class="col-md-8">
                  <input id="email" type="text" class="form-control" name="bairro" required autocomplete="" autofocus>
              ...
              <div class="row mb-3">
                <label for="email" class="col-md-4 col-form-label text-md-end" style="color: #ffff">Telefone</label>
                <div class="col-md-8">
                  <input id="telefone" type="text" class="form-control" name="telefone" required autocomplete="" autofocus>
